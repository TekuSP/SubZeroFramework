...
/// <summary>Body ViewModel for the Framework 13 modules layout route (accessor bridge, see ModulesAccessor).</summary>
public sealed class ModulesFw13Model(ModulesAccessor accessor)
{
