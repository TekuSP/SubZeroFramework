...
public sealed partial class OnboardStatusSectionView : UserControl, INotifyPropertyChanged
{
    public OnboardStatusSectionView()
    {
    ...
    public DeviceCapabilitiesOnboardStatusSectionModel ViewModel
    {
        get => field;
        set
        {
