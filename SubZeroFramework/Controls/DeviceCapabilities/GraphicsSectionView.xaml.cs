...
public sealed partial class GraphicsSectionView : UserControl, INotifyPropertyChanged
{
    public GraphicsSectionView()
    {
    ...
    public DeviceCapabilitiesGraphicsSectionModel ViewModel
    {
        get => field;
        set
        {
