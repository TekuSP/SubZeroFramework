...
description: "Use when finishing SubZeroFramework work, reviewing completed changes, and updating docs/ReleasePlan.md, .github/copilot-instructions.md, README, service docs, or other markdown so repo documentation reflects what was done and what remains."
...
- ONLY edit markdown files that are actually affected by the completed work, with `docs/ReleasePlan.md` and `.github/copilot-instructions.md` as the default anchors.
...
2. Update `docs/ReleasePlan.md` so roadmap status, recent completed work, and remaining gaps stay accurate.
